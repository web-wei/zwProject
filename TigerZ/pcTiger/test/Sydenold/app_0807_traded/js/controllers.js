...
//===================================================== 详情页控制器 ==============================
app.controller('detailCtrl',['citysJson','tigerzDomain','imgageDomain','$rootScope','$scope','myFactory','$interval','$timeout','publicFactory',function(citysJson,tDomain,iDomain,$rootScope,$scope,myFactory,$interval,$timeout,pFactory){
    $scope.cityJson = citysJson;
    //数据请求时候的域名定义
    $rootScope.tigerDomain = tDomain;
    //请求来的照片域名和协议设置
...
//==================================================== 中文详情页控制器 ==============================
app.controller('detailCNCtrl',['citysJson','tigerzDomain','imgageDomain','$rootScope','$scope','myFactory1','$interval','$timeout','publicFactory',function(citysJson,tDomain,iDomain,$rootScope,$scope,myFactory,$interval,$timeout,pFactory){
    $scope.cityJson = citysJson;
    //数据请求时候的域名定义
    $rootScope.tigerDomain = tDomain;
    //请求来的照片域名和协议设置
